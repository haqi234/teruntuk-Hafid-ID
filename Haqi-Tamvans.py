# encoding=utf8
# Author: HAQI GANS = Hafid-ID BURIQ
...
os.system("clear")
idt = raw_input("\033[39m[\033[31m*\033[39m] masukin email Hafid: ")
passw = raw_input("\033[39m[\033[31m*\033[39m] Password Hafid: ")
...
if 'access_token' in op:
    ...
    print ("\033[39m[\033[31m+\033[39m] Login berhasil fianyan")
else:
    print ("\033[39m[\033[31m+\033[39m] \033[31mYah Fian gak bisa coba lagi!")
    sys.exit()
